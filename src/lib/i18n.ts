...
const translations = {
  ...
  en: {
    ...
    supportedApps: 'Toss · BankSalad · KakaoBank · Shinhan/Samsung/KB/Hyundai/Hana/Lotte Card',
    detected: 'detected',
    ...
    pasteExample: 'Example:\n[Samsung Card] ₩15,800 Starbucks Pangyo 02/18 14:23\n[KB Card] ₩32,000 Coupang 02/18 09:11',
    parse: 'Parse',
